...
function Grid() {
  return (
    <div className = 'grid grid-rows-1 w-full h-2/3 gap-3 pb-2 px-20 absolute top-60 grid-cols-5'>
        ...
        <GridItem itemDescription='Search all the beverages over various parameters and their combinations.' color = {'bg-yellow-300 hover:bg-yellow-400'} Icon = {BiSearch} IconArt = {BiSearch} itemTitle = {'Search'} route = {'/search'} />
